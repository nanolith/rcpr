...
/* postconditions. */
RCPR_MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    RCPR_SYM(list_clear), status retval, RCPR_SYM(list)* l)
        /* l is a valid list. */
        RCPR_MODEL_ASSERT(property_list_valid(l));
RCPR_MODEL_CONTRACT_POSTCONDITIONS_END(RCPR_SYM(list_clear))
...
/* preconditions. */
RCPR_MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    RCPR_SYM(list_resource_handle), RCPR_SYM(list)* l)
        /* l is a valid list. */
        RCPR_MODEL_ASSERT(property_list_valid(l));
RCPR_MODEL_CONTRACT_PRECONDITIONS_END(RCPR_SYM(list_resource_handle))

/* postconditions. */
RCPR_MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    RCPR_SYM(list_resource_handle), RCPR_SYM(resource)* retval,
    RCPR_SYM(list)* l)
        /* retval is a valid resource. */
        RCPR_MODEL_ASSERT(prop_resource_valid(retval));
RCPR_MODEL_CONTRACT_POSTCONDITIONS_END(RCPR_SYM(list_resource_handle))
...
/* postconditions. */
RCPR_MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    RCPR_SYM(list_node_resource_handle), RCPR_SYM(resource)* retval,
    RCPR_SYM(list_node)* node)
        /* retval is a valid resource. */
        RCPR_MODEL_ASSERT(prop_resource_valid(retval));
RCPR_MODEL_CONTRACT_POSTCONDITIONS_END(RCPR_SYM(list_node_resource_handle))
...
/* preconditions. */
RCPR_MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    RCPR_SYM(list_head), RCPR_SYM(list_node)** node, RCPR_SYM(list)* l)
        /* l is a valid list. */
        RCPR_MODEL_ASSERT(property_list_valid(l));
        /* node is a valid pointer. */
        RCPR_MODEL_CHECK_OBJECT_RW(node, sizeof(*node));
RCPR_MODEL_CONTRACT_PRECONDITIONS_END(RCPR_SYM(list_head))

/* postconditions. */
RCPR_MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    RCPR_SYM(list_head), status retval, RCPR_SYM(list_node)** node,
    RCPR_SYM(list)* l)
...
RCPR_MODEL_CONTRACT_POSTCONDITIONS_END(RCPR_SYM(list_head))
...
/* preconditions. */
RCPR_MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    RCPR_SYM(list_tail), RCPR_SYM(list_node)** node, RCPR_SYM(list)* l)
        /* l is a valid list. */
        RCPR_MODEL_ASSERT(property_list_valid(l));
        /* node is a valid pointer. */
        RCPR_MODEL_CHECK_OBJECT_RW(node, sizeof(*node));
...
/* preconditions. */
RCPR_MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    RCPR_SYM(list_count), RCPR_SYM(list)* l)
        /* l is a valid list. */
        RCPR_MODEL_ASSERT(property_list_valid(l));
...
/* postconditions. */
RCPR_MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    RCPR_SYM(list_node_child), status retval, RCPR_SYM(resource)** r,
    RCPR_SYM(list_node)* node)
...
RCPR_MODEL_CONTRACT_POSTCONDITIONS_END(RCPR_SYM(list_node_child))
...
/* preconditions. */
RCPR_MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    RCPR_SYM(list_node_next), RCPR_SYM(list_node)** next,
    RCPR_SYM(list_node)* node)
        /* node is a valid list node. */
        RCPR_MODEL_ASSERT(property_list_node_valid(node));
        /* next is a valid pointer. */
        RCPR_MODEL_CHECK_OBJECT_RW(next, sizeof(*next));
RCPR_MODEL_CONTRACT_PRECONDITIONS_END(RCPR_SYM(list_node_next))

/* postconditions. */
RCPR_MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    RCPR_SYM(list_node_next), status retval, RCPR_SYM(list_node)** next,
    RCPR_SYM(list_node)* node)
        /* retval is always successful. TODO change to void. */
        RCPR_MODEL_ASSERT(STATUS_SUCCESS == retval);
        /* if *next is not NULL... */
