...
RCPR_MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    RCPR_SYM(slist_create), status retval, RCPR_SYM(slist)** l,
    RCPR_SYM(allocator)* a)
        ...
        {
            /* the slist pointer is set to NULL. */
...
RCPR_MODEL_CONTRACT_POSTCONDITIONS_END(RCPR_SYM(slist_create))
...
/* preconditions. */
RCPR_MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    RCPR_SYM(slist_insert_head), RCPR_SYM(slist)* l, RCPR_SYM(resource)* r)
        /* l is a valid slist. */
        RCPR_MODEL_ASSERT(property_slist_valid(l));
...
/* preconditions. */
RCPR_MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    RCPR_SYM(slist_append_tail), RCPR_SYM(slist)* l, RCPR_SYM(resource)* r)
        /* l is a valid slist. */
        RCPR_MODEL_ASSERT(property_slist_valid(l));
        /* r is a valid resource. */
        RCPR_MODEL_ASSERT(prop_resource_valid(r));
RCPR_MODEL_CONTRACT_PRECONDITIONS_END(RCPR_SYM(slist_append_tail))

/* postconditions. */
RCPR_MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    RCPR_SYM(slist_append_tail), status retval, RCPR_SYM(slist)* l,
    RCPR_SYM(resource)* r)
        /* l is a valid slist. */
        RCPR_MODEL_ASSERT(property_slist_valid(l));
        /* This method either succeeds or fails with
        ...
        RCPR_MODEL_ASSERT(
            (STATUS_SUCCESS == retval)
         || (ERROR_GENERAL_OUT_OF_MEMORY == retval));
RCPR_MODEL_CONTRACT_POSTCONDITIONS_END(RCPR_SYM(slist_append_tail))
...
/* preconditions. */
RCPR_MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    RCPR_SYM(slist_append), RCPR_SYM(slist_node)* node, RCPR_SYM(resource)* r)
...
/* preconditions. */
RCPR_MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    RCPR_SYM(slist_node_child_swap), RCPR_SYM(slist_node)* node,
    RCPR_SYM(resource)** r)
        /* node is a valid slist node. */
        RCPR_MODEL_ASSERT(property_slist_node_valid(node));
...
RCPR_MODEL_CONTRACT_PRECONDITIONS_END(RCPR_SYM(slist_node_child_swap))

/* postconditions. */
RCPR_MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    RCPR_SYM(slist_node_child_swap), status retval, RCPR_SYM(slist_node)* node,
    RCPR_SYM(resource)** r)
...
RCPR_MODEL_CONTRACT_POSTCONDITIONS_END(RCPR_SYM(slist_node_child_swap))
...
/* postconditions. */
RCPR_MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    RCPR_SYM(slist_pop), status retval, RCPR_SYM(slist)* l,
    RCPR_SYM(resource)** r)
        /* l is a valid slist. */
        RCPR_MODEL_ASSERT(property_slist_valid(l));
        /* on success... */
...
RCPR_MODEL_CONTRACT_POSTCONDITIONS_END(RCPR_SYM(slist_pop))
...
/* preconditions. */
RCPR_MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    RCPR_SYM(slist_node_next_pop), RCPR_SYM(slist_node)* node,
    RCPR_SYM(resource)** r)
        /* node is a valid slist node. */
        RCPR_MODEL_ASSERT(property_slist_node_valid(node));
        /* r is a valid pointer. */
...
RCPR_MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    RCPR_SYM(slist_swap), RCPR_SYM(slist)* left, RCPR_SYM(slist)* right)
        ...
        /* right is a valid slist. */
        RCPR_MODEL_ASSERT(property_slist_valid(right));
RCPR_MODEL_CONTRACT_POSTCONDITIONS_END(RCPR_SYM(slist_swap))
...
/* postconditions. */
RCPR_MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    RCPR_SYM(slist_resource_handle), RCPR_SYM(resource)* retval,
    RCPR_SYM(slist)* l)
        /* retval is a valid resource. */
        RCPR_MODEL_ASSERT(prop_resource_valid(retval));
RCPR_MODEL_CONTRACT_POSTCONDITIONS_END(RCPR_SYM(slist_resource_handle))
...
/* preconditions. */
RCPR_MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    RCPR_SYM(slist_node_resource_handle), RCPR_SYM(slist_node)* node)
        /* node is a valid slist node. */
        RCPR_MODEL_ASSERT(property_slist_node_valid(node));
...
/* preconditions. */
RCPR_MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    RCPR_SYM(slist_head), RCPR_SYM(slist_node)** node, RCPR_SYM(slist)* l)
        /* l is a valid slist. */
        RCPR_MODEL_ASSERT(property_slist_valid(l));
...
/* postconditions. */
RCPR_MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    RCPR_SYM(slist_tail), status retval, RCPR_SYM(slist_node)** node,
    RCPR_SYM(slist)* l)
        /* This method always returns STATUS_SUCCESS. TODO - make void. */
        RCPR_MODEL_ASSERT(STATUS_SUCCESS == retval);
        /* if *node is not NULL... */
...
RCPR_MODEL_CONTRACT_POSTCONDITIONS_END(RCPR_SYM(slist_tail))
...
/* postconditions. */
RCPR_MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    RCPR_SYM(slist_node_child), status retval, RCPR_SYM(resource)** r,
    RCPR_SYM(slist_node)* node)
...
RCPR_MODEL_CONTRACT_POSTCONDITIONS_END(RCPR_SYM(slist_node_child))
