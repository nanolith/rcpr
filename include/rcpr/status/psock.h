...
/**
 * \brief The psock method is undefined.
 */
#define ERROR_PSOCK_METHOD_UNDEFINED \
    STATUS_CODE(1, RCPR_COMPONENT_PSOCK, 0x0022)

/**
 * \brief setsockopt failed.
 */
#define ERROR_PSOCK_SETSOCKOPT \
    STATUS_CODE(1, RCPR_COMPONENT_PSOCK, 0x0023)
