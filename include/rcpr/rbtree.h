...
/**
 * \brief Return the node to the right of the given node.
 *
 * \param tree          The \ref rbtree instance.
 * \param x             The referenced \ref rbtree_node.
 *
 * \returns the node to the right of the referenced node, or tree->nil if none
 * is found.
 */
RCPR_SYM(rbtree_node)*
RCPR_SYM(rbtree_right_node)(
    RCPR_SYM(rbtree)* tree, RCPR_SYM(rbtree_node)* x);

/**
 * \brief Return the parent node of the given node.
 *
 * \param tree          The \ref rbtree instance.
 * \param x             The referenced \ref rbtree_node.
 *
 * \returns the parent node of the referenced node, or tree->nil if none is
 * found.
 */
RCPR_SYM(rbtree_node)*
RCPR_SYM(rbtree_parent_node)(
    RCPR_SYM(rbtree)* tree, RCPR_SYM(rbtree_node)* x);
...
#define __INTERNAL_RCPR_IMPORT_rbtree_sym(sym) \
    ...
    static inline RCPR_SYM(rbtree_node)* sym ## rbtree_left_node( \
        RCPR_SYM(rbtree)* x, RCPR_SYM(rbtree_node)* y) { \
            return RCPR_SYM(rbtree_left_node)(x,y); } \
    static inline RCPR_SYM(rbtree_node)* sym ## rbtree_right_node( \
        RCPR_SYM(rbtree)* x, RCPR_SYM(rbtree_node)* y) { \
            return RCPR_SYM(rbtree_right_node)(x,y); } \
