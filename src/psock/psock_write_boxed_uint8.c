/**
 * \file psock/psock_write_boxed_uint8.c
 *
 * \brief Write a boxed 8-bit unsigned integer value to a \ref psock instance.
 *
    ...
    RCPR_SYM(psock)* sock, uint8_t val)
{
    ...
    status retval = psock_write_raw_uint32(sock, PSOCK_BOXED_TYPE_UINT8);
    ...
    return psock_write_raw_uint8(sock, val);
}
