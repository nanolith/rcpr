/**
 * \file psock/psock_write_boxed_uint32.c
 *
 * \brief Write a boxed 32-bit unsigned integer value to a \ref psock instance.
 *
    ...
    psock* sock, uint32_t val)
{
    ...
    status retval = psock_write_raw_uint32(sock, PSOCK_BOXED_TYPE_UINT32);
    ...
    return psock_write_raw_uint32(sock, val);
}
