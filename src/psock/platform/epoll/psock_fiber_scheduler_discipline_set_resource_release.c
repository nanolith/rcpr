...
/* the vtable entry for the psock epoll discipline chaned instance. */
RCPR_VTABLE
resource_vtable psock_epoll_discipline_chained_vtable = {
    &psock_epoll_discipline_chained_release };
    ...
    RCPR_SYM(fiber_scheduler_discipline)* disc, RCPR_SYM(resource)* context)
{
    ...
    resource_init(pdisc, &psock_epoll_discipline_chained_vtable);
}
