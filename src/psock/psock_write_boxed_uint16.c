/**
 * \file psock/psock_write_boxed_uint16.c
 *
 * \brief Write a boxed 16-bit unsigned integer value to a \ref psock instance.
 *
    ...
    RCPR_SYM(psock)* sock, uint16_t val)
{
    ...
    status retval = psock_write_raw_uint32(sock, PSOCK_BOXED_TYPE_UINT16);
    ...
    return psock_write_raw_uint16(sock, val);
}
