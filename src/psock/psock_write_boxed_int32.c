/**
 * \file psock/psock_write_boxed_int32.c
 *
 * \brief Write a boxed 32-bit integer value to a \ref psock instance.
 *
    ...
    RCPR_SYM(psock)* sock, int32_t val)
{
    ...
    status retval = psock_write_raw_uint32(sock, PSOCK_BOXED_TYPE_INT32);
    ...
    return psock_write_raw_int32(sock, val);
}
