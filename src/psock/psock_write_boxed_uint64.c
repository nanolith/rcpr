/**
 * \file psock/psock_write_boxed_uint64.c
 *
 * \brief Write a boxed 64-bit unsigned integer value to a \ref psock instance.
 *
    ...
    RCPR_SYM(psock)* sock, uint64_t val)
{
    ...
    status retval = psock_write_raw_uint32(sock, PSOCK_BOXED_TYPE_UINT64);
    ...
    return psock_write_raw_uint64(sock, val);
}
