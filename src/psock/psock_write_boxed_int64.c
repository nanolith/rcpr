/**
 * \file psock/psock_write_boxed_int64.c
 *
 * \brief Write a boxed 64-bit integer value to a \ref psock instance.
 *
    ...
    RCPR_SYM(psock)* sock, int64_t val)
{
    ...
    status retval = psock_write_raw_uint32(sock, PSOCK_BOXED_TYPE_INT64);
    ...
    return psock_write_raw_int64(sock, val);
}
