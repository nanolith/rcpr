/**
 * \file test/test_psock_read_write_raw_uint8.cpp
 *
 * \brief Unit tests for psock_read_raw_uint8 / psock_write_raw_uint8.
 */
...
TEST_SUITE(psock_read_write_raw_uint8);

/**
 * Verify that we can read and write raw uint8 values.
 */
TEST(read_write)
{
    ...
    int lhs;
    int rhs;
    const uint8_t EXPECTED_VALUE = 83;
    uint8_t val = 0;
