/**
 * \file test/test_psock_read_write_boxed_int32.cpp
 *
 * \brief Unit tests for psock_read_boxed_int32 / psock_write_boxed_int32.
 */
...
TEST_SUITE(psock_read_write_boxed_int32);

/**
 * Verify that we can read and write boxed int32 values.
 */
TEST(read_write)
{
