/**
 * \file test/test_psock_read_write_raw_int64.cpp
 *
 * \brief Unit tests for psock_read_raw_int64 / psock_write_raw_int64.
 */
...
TEST_SUITE(psock_read_write_raw_int64);

/**
 * Verify that we can read and write raw int64 values.
 */
TEST(read_write)
{
