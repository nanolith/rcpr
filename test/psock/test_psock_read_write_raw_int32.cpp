/**
 * \file test/test_psock_read_write_raw_int32.cpp
 *
 * \brief Unit tests for psock_read_raw_int32 / psock_write_raw_int32.
 */
...
/**
 * Verify that we can read and write raw int32 values.
 */
TEST(read_write)
{
