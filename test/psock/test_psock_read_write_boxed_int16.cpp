/**
 * \file test/test_psock_read_write_boxed_int16.cpp
 *
 * \brief Unit tests for psock_read_boxed_int16 / psock_write_boxed_int16.
 */
...
TEST_SUITE(psock_read_write_boxed_int16);

/**
 * Verify that we can read and write boxed int16 values.
 */
TEST(read_write)
{
