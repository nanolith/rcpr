/**
 * \file test/test_psock_read_write_boxed_int8.cpp
 *
 * \brief Unit tests for psock_read_boxed_int8 / psock_write_boxed_int8.
 */
...
TEST_SUITE(psock_read_write_boxed_int8);

/**
 * Verify that we can read and write boxed int8 values.
 */
TEST(read_write)
{
