/**
 * \file test/test_psock_read_write_boxed_uint16.cpp
 *
 * \brief Unit tests for psock_read_boxed_uint16 / psock_write_boxed_uint16.
 */
...
TEST_SUITE(psock_read_write_boxed_uint16);

/**
 * Verify that we can read and write boxed uint16 values.
 */
TEST(read_write)
{
